...
for i in range(0, 17):
    ...
    for j in np.arange(2, 20, 0.05):
        ...
        pyautogui.typewrite("./infraGA/bin/infraga-2d -prop ./infraGA/examples/profs/" + atmo + " src_alt=" + str(j) + "incl_min=-89" + " incl_max=89")
        pyautogui.press("enter")
        #Rename and move the file
        newFileName = "Atmo" + str(i) + "_Alt" + str(j) + ".raypaths.dat"
        pyautogui.typewrite("mv ./infraGA/examples/profs/example" + str(i) + ".raypaths.dat" + " ./raw_raypaths/" + newFileName)
        pyautogui.press("enter")